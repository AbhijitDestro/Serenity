...
// Helper function to extract text from Gemini API results
...
export const sendMessage = async (req: Request, res: Response) => {
  try {
    ...
    const analysisText = await extractTextFromGenResult(analysisResult, logger, "analysis");
    ...
    const response = await extractTextFromGenResult(responseResult, logger, "response");
