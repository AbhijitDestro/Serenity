...
import { AnxietyActivity } from "@/components/games/anxiety-games";
...
export default function Dashboard() {
  ...
  const handleRefresh = async () => {
    ...
    setTimeout(() => setIsRefreshing(false), 500); // Min loading time for UX
  };
  ...
  // Load activities from history
  const loadActivities = useCallback(async () => {
    try {
      const userActivities = await getActivityHistory();
  ...
  // Removed conflicting useEffect that was overwriting correct stats
  ...
  useEffect(() => {
    if (activities.length > 0) {
      ...
      // Set default insights if no activities
      setInsights([
        {
          title: "Welcome!",
          description: "Start tracking your activities and mood to get personalized insights.",
          icon: Sparkles,
          priority: "high",
        }
      ]);
  ...
  return (
    <div className="min-h-screen bg-background">
      <Container className="pt-36 pb-8 space-y-6">
        {/* Header Section */}
